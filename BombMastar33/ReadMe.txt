========================================================================
       MICROSOFT FOUNDATION CLASS ライブラリ : BombMastar
========================================================================


AppWizard が生成した BombMastar には、Microsoft Foundation Class の基本的な
使い方が示されています。アプリケーション作成のひな型としてお使いください。

このファイルには BombMastar を構成している各ファイルの概要説明が含まれています。
...
BombMastar.h
    ...
    みます） をインクルードし、また CBombMastarApp アプリケーションクラスを宣
    言します。

BombMastar.cpp
    このファイルは CBombMastarApp アプリケーションクラスを含むアプリケーション
    の中心となるソースファイルです。
...
res\BombMastar.ico
    ...
    ルです。このアイコンはリソース ファイル BombMastar.rc によってインクルード
    されます。
...
res\Toolbar.bmp
    ...
    リソースエディタで編集し、BombMastar.rc ファイル内の IDR_MAINFRAME TOOLBAR 配列を
    変更してください。
/////////////////////////////////////////////////////////////////////////////

AppWizard は 1 つのドキュメントタイプと 1 つのビューを作成します。

BombMastarDoc.h, BombMastarDoc.cpp - ドキュメント
    これらのファイルは CBombMastarDoc クラスを含みます。特別なドキュメント デ
    ータを付け加えたり、CBombMastarDoc::Serialize を使ったファイルのセーブや
    ロード機能をインプリメントしたいときはこのファイルを編集してください。

BombMastarView.h, BombMastarView.cpp - ビュー
    これらのファイルは CBombMastarView クラスを含みます。
    CBombMastarView オブジェクトは CBombMastarDoc オブジェクトを表示するために
    使います。
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済ヘッダー ファイル (PCH) BombMastar.pch 
